...
contract('HTLCWETH', ([recipient, owner, ign2, ign3, ign4, ign5, ign6, ign7, ign8, ign9, ign10, ign1,user ,ign11, storeman]) => {
   ...
   before(`init`, async () => {
       ...
       await StoremanGroupAdminInstance.setSmgEnableUserWhiteList(0,false, {from: owner});
       ...
       await  StoremanGroupAdminInstance.storemanGroupRegister(0,storeman,10,{from:storeman,value:regDeposit,gas:4000000});
       ...
       wan2CoinRatio = (await StoremanGroupAdminInstance.mapCoinInfo(0))[0];
       txFeeRatio = (await StoremanGroupAdminInstance.mapCoinSmgInfo(0, storeman))[3];
